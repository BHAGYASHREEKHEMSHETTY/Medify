...
export default function BookingModal({
  ...
  const handleBooking = (e) => {
    ...
    const newBooking = {
      ...
      bookingTime: bookingDetails.bookingTime || "Not specified",
    };
    ...
    // Delay close slightly for UI effect
    setTimeout(() => setOpen(false), 400);
  };

  // Google Tag Manager-style event
  const triggerEvent = () => {
      ...
      >
        ...
        <Typography fontSize={14} mb={3}>
          ...
          <Box component="span" fontWeight={600}>
            {`${bookingDetails.bookingTime || "N/A"} on ${formatDate(
